...
Sub Load_Data
	Try
		...
		Cursor = sql1.ExecQuery($"SELECT        ReturnSalesInvoiceH.ReturnReturnSalesInvoiceHID, ReturnSalesInvoiceH.InvDT, ReturnSalesInvoiceH.InvTotal, ReturnSalesInvoiceH.UserID, ReturnSalesInvoiceH.InvTotalTax, ReturnSalesInvoiceH.InvTotalDiscount, ReturnSalesInvoiceH.InvTotalShipping, 
...
FROM            ReturnSalesInvoiceH LEFT OUTER JOIN
		...
		Do While Cursor.NextRow
			...
			str = str & "  <tr> "
			str = str & "<td>"& Cursor.GetInt("ReturnReturnSalesInvoiceHID") &"</td>"
			str = str & "<td>"& Cursor.GetString("InvDT") &"</td>"
			str = str & "<td>"& Cursor.GetString("CustomerName") &"</td>"
			str = str & "<td>"& Cursor.GetString("InvTotal") &"</td>"
			...
			&" <a href='javascript:void(0);' onclick=""editTbl("& Cursor.GetInt("ReturnReturnSalesInvoiceHID") &")"" class='btn btn-primary btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-pencil' ></i></div></a> " _
			&" <a href='javascript:void(0);' onclick=""deleteTbl("& Cursor.GetInt("ReturnReturnSalesInvoiceHID") &")"" class='btn btn-danger btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-trash' ></i></div></a> " _
			&" </td> </tr>"
...
Private Sub Edit_button_table(params As Map)
	...
	ws.Eval("document.location.replace('AddReturnSalesInfo.html')",Null)
