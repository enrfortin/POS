...
Sub Load_Data
	Try
		...
		Cursor = sql1.ExecQuery($"SELECT        ReturnPurchaseInvoiceH.ReturnPurchaseInvoiceHID, ReturnPurchaseInvoiceH.InvDT, ReturnPurchaseInvoiceH.InvTotal, ReturnPurchaseInvoiceH.InvTotalTax, ReturnPurchaseInvoiceH.InvTotalDiscount, ReturnPurchaseInvoiceH.InvTotalShipping, 
...
FROM            ReturnPurchaseInvoiceH LEFT OUTER JOIN
		...
		Do While Cursor.NextRow
			...
			str = str & "  <tr> "
			str = str & "<td>"& Cursor.GetInt("ReturnPurchaseInvoiceHID") &"</td>"
			...
			&" <a href='javascript:void(0);' onclick=""editTbl("& Cursor.GetInt("ReturnPurchaseInvoiceHID") &")"" class='btn btn-primary btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-pencil' ></i></div></a> " _
			&" <a href='javascript:void(0);' onclick=""deleteTbl("& Cursor.GetInt("ReturnPurchaseInvoiceHID") &")"" class='btn btn-danger btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-trash' ></i></div></a> " _
			&" </td> </tr>"
