...
public class warehouseinformation_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 2;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 3;BA.debugLine="Private ws As WebSocket";
warehouseinformation._ws = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket");__ref.setField("_ws",warehouseinformation._ws);
 //BA.debugLineNum = 4;BA.debugLine="Private divlist As JQueryElement";
warehouseinformation._divlist = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divlist",warehouseinformation._divlist);
 //BA.debugLineNum = 5;BA.debugLine="Private lblusernamemain As JQueryElement";
warehouseinformation._lblusernamemain = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_lblusernamemain",warehouseinformation._lblusernamemain);
 //BA.debugLineNum = 6;BA.debugLine="Private divMenu As JQueryElement";
warehouseinformation._divmenu = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divmenu",warehouseinformation._divmenu);
 //BA.debugLineNum = 7;BA.debugLine="Private sql1 As SQL";
warehouseinformation._sql1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL");__ref.setField("_sql1",warehouseinformation._sql1);
 //BA.debugLineNum = 9;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _delete_button_table(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("Delete_button_table (warehouseinformation) ","warehouseinformation",8,__ref.getField(false, "ba"),__ref,85);
if (RapidSub.canDelegate("delete_button_table")) { return __ref.runUserSub(false, "warehouseinformation","delete_button_table", __ref, _params);}
...
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 89;BA.debugLine="sql1.ExecNonQuery(\"delete from WarehouseInfo wher";
Debug.ShouldStop(16777216);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("delete from WarehouseInfo where WarehouseID="),_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val")))))));
...
try {
		Debug.PushSubsStack("Edit_button_table (warehouseinformation) ","warehouseinformation",8,__ref.getField(false, "ba"),__ref,77);
if (RapidSub.canDelegate("edit_button_table")) { return __ref.runUserSub(false, "warehouseinformation","edit_button_table", __ref, _params);}
Debug.locals.put("params", _params);
...
__ref.getField(false,"_ws" /*RemoteObject*/ ).runMethod(false,"getSession").runVoidMethod ("SetAttribute",(Object)(BA.ObjectToString("CatID")),(Object)(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))));
 BA.debugLineNum = 81;BA.debugLine="ws.Eval(\"document.location.replace('AddWarehouseI";
Debug.ShouldStop(65536);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(BA.ObjectToString("document.location.replace('AddWarehouseInfo.html')")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), warehouseinformation.__c.getField(false,"Null")));
...
try {
		Debug.PushSubsStack("Initialize (warehouseinformation) ","warehouseinformation",8,__ref.getField(false, "ba"),__ref,11);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "warehouseinformation","initialize", __ref, _ba);}
...
try {
		Debug.PushSubsStack("Load_Data (warehouseinformation) ","warehouseinformation",8,__ref.getField(false, "ba"),__ref,34);
if (RapidSub.canDelegate("load_data")) { return __ref.runUserSub(false, "warehouseinformation","load_data", __ref);}
...
_cursor = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("Cursor", _cursor);
 BA.debugLineNum = 50;BA.debugLine="Cursor = sql1.ExecQuery(\"select * from Warehouse";
Debug.ShouldStop(131072);
_cursor = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.createImmutable("select * from WarehouseInfo")));Debug.locals.put("Cursor", _cursor);
...
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <tr> "));Debug.locals.put("str", _str);
 BA.debugLineNum = 55;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"Warehouse";
Debug.ShouldStop(4194304);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("WarehouseID"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 56;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"Warehouse";
...
Debug.ShouldStop(33554432);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <td style=' vertical-align: middle !important; white-space: nowrap !important; '> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' onclick=\"editTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("WarehouseID"))),RemoteObject.createImmutable(")\" class='btn btn-primary btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-pencil' ></i></div></a> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' class='btn btn-danger btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-trash' onclick=\"deleteTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("WarehouseID"))),RemoteObject.createImmutable(")\"></i></div></a> "),RemoteObject.createImmutable(" </td> </tr>"));Debug.locals.put("str", _str);
 }
;
...
warehouseinformation.__c.runVoidMethod ("LogImpl","25701670",BA.ObjectToString(warehouseinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls (warehouseinformation) ","warehouseinformation",8,__ref.getField(false, "ba"),__ref,97);
if (RapidSub.canDelegate("load_datatable_controls")) { return __ref.runUserSub(false, "warehouseinformation","load_datatable_controls", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
Debug.ShouldStop(4194304);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(_str),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), warehouseinformation.__c.getField(false,"Null")));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(33554432);
warehouseinformation.__c.runVoidMethod ("LogImpl","25898265",BA.ObjectToString(warehouseinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("WebSocket_Connected (warehouseinformation) ","warehouseinformation",8,__ref.getField(false, "ba"),__ref,15);
if (RapidSub.canDelegate("websocket_connected")) { return __ref.runUserSub(false, "warehouseinformation","websocket_connected", __ref, _websocket1);}
...
Debug.ShouldStop(65536);
warehouseinformation._main.runVoidMethod ("_validateusers" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_lblusernamemain" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_divmenu" /*RemoteObject*/ )));
...
Debug.ShouldStop(1048576);
__ref.setField ("_sql1" /*RemoteObject*/ ,warehouseinformation._main._pool /*RemoteObject*/ .runMethod(false,"GetConnection"));
 BA.debugLineNum = 23;BA.debugLine="Load_Data";
Debug.ShouldStop(4194304);
__ref.runClassMethod (b4j.example.warehouseinformation.class, "_load_data" /*RemoteObject*/ );
 BA.debugLineNum = 25;BA.debugLine="Load_Datatable_Controls";
Debug.ShouldStop(16777216);
__ref.runClassMethod (b4j.example.warehouseinformation.class, "_load_datatable_controls" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (warehouseinformation) ","warehouseinformation",8,__ref.getField(false, "ba"),__ref,29);
if (RapidSub.canDelegate("websocket_disconnected")) { return __ref.runUserSub(false, "warehouseinformation","websocket_disconnected", __ref);}
