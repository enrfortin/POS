...
public class addreturnpurchaseinfo_subs_0 {


public static RemoteObject  _btnaddproduct_click(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("btnaddproduct_Click (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,95);
if (RapidSub.canDelegate("btnaddproduct_click")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","btnaddproduct_click", __ref, _params);}
...
__ref.runClassMethod (b4j.example.addreturnpurchaseinfo.class, "_load_addedproducts_temp" /*RemoteObject*/ );
...
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29175058",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("btncancel_Click (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,345);
if (RapidSub.canDelegate("btncancel_click")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","btncancel_click", __ref, _params);}
Debug.locals.put("Params", _params);
...
try {
		Debug.PushSubsStack("btnsave_Click (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,201);
if (RapidSub.canDelegate("btnsave_click")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","btnsave_click", __ref, _params);}
...
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 237;BA.debugLine="sql1.ExecNonQuery2($\"UPDATE ReturnPurchaseInvo";
Debug.ShouldStop(4096);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)((RemoteObject.concat(RemoteObject.createImmutable("UPDATE ReturnPurchaseInvoiceH\n"),RemoteObject.createImmutable("				   SET InvDT = ?\n"),RemoteObject.createImmutable("				      ,InvTotal = ?\n"),RemoteObject.createImmutable("				      ,InvTotalTax = ?\n"),RemoteObject.createImmutable("				      ,InvTotalDiscount = ?\n"),RemoteObject.createImmutable("				      ,InvTotalShipping = ?\n"),RemoteObject.createImmutable("				      ,PaidAmount = ?\n"),RemoteObject.createImmutable("				      ,StrNotes = ?\n"),RemoteObject.createImmutable("				      ,SupplierID = ?\n"),RemoteObject.createImmutable("				 WHERE ReturnPurchaseInvoiceHID=?")))),(Object)(addreturnpurchaseinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {9},new Object[] {__ref.getField(false,"_txtinvdate" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_dblinvtotal),(_dblinvtotaltax),(_dblinvtotaldiscount),RemoteObject.createImmutable((0)),RemoteObject.createImmutable((0)),__ref.getField(false,"_txtinvnote" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),__ref.getField(false,"_cmbsupplier" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_invoiceid)})))));
...
Debug.ShouldStop(33554432);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 251;BA.debugLine="sql1.ExecNonQuery2(\"delete from ReturnPurchase";
Debug.ShouldStop(67108864);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)(BA.ObjectToString("delete from ReturnPurchaseInvoiceD where ReturnPurchaseInvoiceHID=?")),(Object)(addreturnpurchaseinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_invoiceid)})))));
...
Debug.ShouldStop(4);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 260;BA.debugLine="sql1.ExecNonQuery2($\"INSERT INTO ReturnPurcha";
Debug.ShouldStop(8);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)((RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO ReturnPurchaseInvoiceD\n"),RemoteObject.createImmutable("			           (ReturnPurchaseInvoiceHID]\n"),RemoteObject.createImmutable("			           ,ProductID\n"),RemoteObject.createImmutable("			           ,ProductSellPrice\n"),RemoteObject.createImmutable("			           ,ProductCostPrice\n"),RemoteObject.createImmutable("			           ,TaxPerc\n"),RemoteObject.createImmutable("			           ,ProductQty)\n"),RemoteObject.createImmutable("			     VALUES\n"),RemoteObject.createImmutable("			           (?\n"),RemoteObject.createImmutable("			           ,?\n"),RemoteObject.createImmutable("			           ,?\n"),RemoteObject.createImmutable("			           ,?\n"),RemoteObject.createImmutable("			           ,?\n"),RemoteObject.createImmutable("			           ,?)")))),(Object)(addreturnpurchaseinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {6},new Object[] {(_invoiceid),(_classtempprod.getField(true,"_productid" /*RemoteObject*/ )),(_classtempprod.getField(true,"_unitprice" /*RemoteObject*/ )),(_classtempprod.getField(true,"_productcostprice" /*RemoteObject*/ )),(_classtempprod.getField(true,"_taxid" /*RemoteObject*/ )),(_classtempprod.getField(true,"_qty" /*RemoteObject*/ ))})))));
...
Debug.ShouldStop(16777216);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 282;BA.debugLine="sql1.ExecNonQuery2($\"INSERT INTO ReturnPurcha";
Debug.ShouldStop(33554432);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)((RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO ReturnPurchaseInvoiceH\n"),RemoteObject.createImmutable("				           (InvDT\n"),RemoteObject.createImmutable("				           ,InvTotal\n"),RemoteObject.createImmutable("				           ,InvTotalTax\n"),RemoteObject.createImmutable("				           ,InvTotalDiscount\n"),RemoteObject.createImmutable("				           ,InvTotalShipping\n"),RemoteObject.createImmutable("				           ,PaidAmount\n"),RemoteObject.createImmutable("				           ,StrNotes\n"),RemoteObject.createImmutable("				           ,SupplierID)\n"),RemoteObject.createImmutable("				     VALUES\n"),RemoteObject.createImmutable("				           (?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?)")))),(Object)(addreturnpurchaseinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {8},new Object[] {__ref.getField(false,"_txtinvdate" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_dblinvtotal),(_dblinvtotaltax),(_dblinvtotaldiscount),RemoteObject.createImmutable((0)),RemoteObject.createImmutable((0)),__ref.getField(false,"_txtinvnote" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),__ref.getField(false,"_cmbsupplier" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue")})))));
...
_rs = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("rs", _rs);
 BA.debugLineNum = 304;BA.debugLine="rs = sql1.ExecQuery(\"select ReturnPurchaseInv";
Debug.ShouldStop(32768);
_rs = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.createImmutable("select ReturnPurchaseInvoiceHID from ReturnPurchaseInvoiceH order by ReturnPurchaseInvoiceHID desc limit 1")));Debug.locals.put("rs", _rs);
 BA.debugLineNum = 305;BA.debugLine="Do While rs.NextRow";
Debug.ShouldStop(65536);
while (_rs.runMethod(true,"NextRow").<Boolean>get().booleanValue()) {
 BA.debugLineNum = 306;BA.debugLine="LastSavedID = rs.GetInt(\"ReturnPurchaseInvoi";
Debug.ShouldStop(131072);
_lastsavedid = _rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("ReturnPurchaseInvoiceHID")));Debug.locals.put("LastSavedID", _lastsavedid);
 }
;
...
Debug.ShouldStop(33554432);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 315;BA.debugLine="sql1.ExecNonQuery2($\"INSERT INTO ReturnPurc";
Debug.ShouldStop(67108864);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)((RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO ReturnPurchaseInvoiceD\n"),RemoteObject.createImmutable("					           (ReturnPurchaseInvoiceHID]\n"),RemoteObject.createImmutable("					           ,ProductID\n"),RemoteObject.createImmutable("					           ,ProductSellPrice\n"),RemoteObject.createImmutable("					           ,ProductCostPrice\n"),RemoteObject.createImmutable("					           ,TaxPerc\n"),RemoteObject.createImmutable("					           ,ProductQty)\n"),RemoteObject.createImmutable("					     VALUES\n"),RemoteObject.createImmutable("					           (?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?)")))),(Object)(addreturnpurchaseinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {6},new Object[] {(_lastsavedid),(_classtempprod.getField(true,"_productid" /*RemoteObject*/ )),(_classtempprod.getField(true,"_unitprice" /*RemoteObject*/ )),(_classtempprod.getField(true,"_productcostprice" /*RemoteObject*/ )),(_classtempprod.getField(true,"_taxid" /*RemoteObject*/ )),(_classtempprod.getField(true,"_qty" /*RemoteObject*/ ))})))));
...
Debug.ShouldStop(16384);
addreturnpurchaseinfo._main.runVoidMethod ("_insert_userslogs" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("Invoice Information")));
...
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29437324",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
addreturnpurchaseinfo._ws = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket");__ref.setField("_ws",addreturnpurchaseinfo._ws);
 //BA.debugLineNum = 5;BA.debugLine="Private txtinvdate,cmbsupplier,txtinvnote,cmbprod";
addreturnpurchaseinfo._txtinvdate = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtinvdate",addreturnpurchaseinfo._txtinvdate);
addreturnpurchaseinfo._cmbsupplier = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_cmbsupplier",addreturnpurchaseinfo._cmbsupplier);
addreturnpurchaseinfo._txtinvnote = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtinvnote",addreturnpurchaseinfo._txtinvnote);
addreturnpurchaseinfo._cmbproduct = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_cmbproduct",addreturnpurchaseinfo._cmbproduct);
addreturnpurchaseinfo._txttax = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txttax",addreturnpurchaseinfo._txttax);
addreturnpurchaseinfo._txtunitprice = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtunitprice",addreturnpurchaseinfo._txtunitprice);
addreturnpurchaseinfo._txtqty = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtqty",addreturnpurchaseinfo._txtqty);
addreturnpurchaseinfo._txtdiscount = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtdiscount",addreturnpurchaseinfo._txtdiscount);
addreturnpurchaseinfo._btnaddproduct = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_btnaddproduct",addreturnpurchaseinfo._btnaddproduct);
addreturnpurchaseinfo._btnsave = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_btnsave",addreturnpurchaseinfo._btnsave);
addreturnpurchaseinfo._btncancel = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_btncancel",addreturnpurchaseinfo._btncancel);
addreturnpurchaseinfo._divproducts = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divproducts",addreturnpurchaseinfo._divproducts);
 //BA.debugLineNum = 7;BA.debugLine="Private TempProductsTable As List";
addreturnpurchaseinfo._tempproductstable = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_tempproductstable",addreturnpurchaseinfo._tempproductstable);
 //BA.debugLineNum = 9;BA.debugLine="Private templistcmbcustomer As List";
addreturnpurchaseinfo._templistcmbcustomer = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_templistcmbcustomer",addreturnpurchaseinfo._templistcmbcustomer);
 //BA.debugLineNum = 10;BA.debugLine="Private templistpaymenttype As List";
addreturnpurchaseinfo._templistpaymenttype = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_templistpaymenttype",addreturnpurchaseinfo._templistpaymenttype);
 //BA.debugLineNum = 11;BA.debugLine="Private lblusernamemain As JQueryElement";
addreturnpurchaseinfo._lblusernamemain = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_lblusernamemain",addreturnpurchaseinfo._lblusernamemain);
 //BA.debugLineNum = 12;BA.debugLine="Private divMenu As JQueryElement";
addreturnpurchaseinfo._divmenu = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divmenu",addreturnpurchaseinfo._divmenu);
 //BA.debugLineNum = 13;BA.debugLine="Private sql1 As SQL";
addreturnpurchaseinfo._sql1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL");__ref.setField("_sql1",addreturnpurchaseinfo._sql1);
 //BA.debugLineNum = 15;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _cmbproduct_change(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("cmbproduct_Change (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,117);
if (RapidSub.canDelegate("cmbproduct_change")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","cmbproduct_change", __ref, _params);}
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
Debug.locals.put("Params", _params);
...
Debug.ShouldStop(1073741824);
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29240586",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Delete_button_table_Products (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,189);
if (RapidSub.canDelegate("delete_button_table_products")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","delete_button_table_products", __ref, _params);}
...
try {
		Debug.PushSubsStack("Initialize (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,17);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","initialize", __ref, _ba);}
...
try {
		Debug.PushSubsStack("Load_AddedProducts_Temp (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,131);
if (RapidSub.canDelegate("load_addedproducts_temp")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","load_addedproducts_temp", __ref);}
...
Debug.ShouldStop(2097152);
__ref.runClassMethod (b4j.example.addreturnpurchaseinfo.class, "_load_datatable_controls" /*RemoteObject*/ );
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e27) {
...
Debug.ShouldStop(16777216);
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29306166",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Customer (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,48);
if (RapidSub.canDelegate("load_customer")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","load_customer", __ref);}
...
Debug.ShouldStop(2);
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29043986",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Data_ByID (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,350);
if (RapidSub.canDelegate("load_data_byid")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","load_data_byid", __ref);}
RemoteObject _invoiceid = RemoteObject.createImmutable(0);
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
...
Debug.ShouldStop(512);
_rs = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("rs", _rs);
 BA.debugLineNum = 363;BA.debugLine="rs = sql1.ExecQuery(\"select * from ReturnPurcha";
Debug.ShouldStop(1024);
_rs = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("select * from ReturnPurchaseInvoiceH where ReturnPurchaseInvoiceHID="),_invoiceid)));Debug.locals.put("rs", _rs);
...
Debug.ShouldStop(262144);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("RunFunction",(Object)(BA.ObjectToString("setSelectedRow")),(Object)(addreturnpurchaseinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_strid),(_rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("SupplierID"))))})))));
 }
;
...
Debug.ShouldStop(16777216);
_rs = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("rs", _rs);
 BA.debugLineNum = 378;BA.debugLine="rs = sql1.ExecQuery(\"select * from ReturnPurcha";
Debug.ShouldStop(33554432);
_rs = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("select * from ReturnPurchaseInvoiceD where ReturnPurchaseInvoiceHID="),_invoiceid)));Debug.locals.put("rs", _rs);
...
Debug.ShouldStop(512);
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29568300",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,399);
if (RapidSub.canDelegate("load_datatable_controls")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","load_datatable_controls", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
Debug.ShouldStop(536870912);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(_str),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), addreturnpurchaseinfo.__c.getField(false,"Null")));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(1);
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29633810",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls2 (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,421);
if (RapidSub.canDelegate("load_datatable_controls2")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","load_datatable_controls2", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
Debug.ShouldStop(2097152);
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29699345",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Products (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,74);
if (RapidSub.canDelegate("load_products")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","load_products", __ref);}
RemoteObject _sb = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
RemoteObject _val = RemoteObject.createImmutable("");
...
Debug.ShouldStop(16777216);
addreturnpurchaseinfo.__c.runVoidMethod ("LogImpl","29109519",BA.ObjectToString(addreturnpurchaseinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("WebSocket_Connected (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,21);
if (RapidSub.canDelegate("websocket_connected")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","websocket_connected", __ref, _websocket1);}
...
Debug.ShouldStop(4194304);
addreturnpurchaseinfo._main.runVoidMethod ("_validateusers" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_lblusernamemain" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_divmenu" /*RemoteObject*/ )));
...
Debug.ShouldStop(134217728);
__ref.setField ("_sql1" /*RemoteObject*/ ,addreturnpurchaseinfo._main._pool /*RemoteObject*/ .runMethod(false,"GetConnection"));
 BA.debugLineNum = 30;BA.debugLine="Load_Customer";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.addreturnpurchaseinfo.class, "_load_customer" /*RemoteObject*/ );
 BA.debugLineNum = 32;BA.debugLine="Load_Products";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.addreturnpurchaseinfo.class, "_load_products" /*RemoteObject*/ );
 BA.debugLineNum = 35;BA.debugLine="Load_Data_ByID";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.addreturnpurchaseinfo.class, "_load_data_byid" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (addreturnpurchaseinfo) ","addreturnpurchaseinfo",14,__ref.getField(false, "ba"),__ref,40);
if (RapidSub.canDelegate("websocket_disconnected")) { return __ref.runUserSub(false, "addreturnpurchaseinfo","websocket_disconnected", __ref);}
