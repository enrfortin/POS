...
public class customersinformation_subs_0 {


public static RemoteObject  _checkismobilebrowser(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("CheckIsMobileBrowser (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,179);
if (RapidSub.canDelegate("checkismobilebrowser")) { return __ref.runUserSub(false, "customersinformation","checkismobilebrowser", __ref);}
...
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(_str),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), customersinformation.__c.getField(false,"Null")));
...
Debug.ShouldStop(4);
customersinformation.__c.runVoidMethod ("LogImpl","23538960",BA.NumberToString(__ref.getField(true,"_intismobiledev" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(16);
customersinformation.__c.runVoidMethod ("LogImpl","23538962",BA.ObjectToString(customersinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
customersinformation._ws = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket");__ref.setField("_ws",customersinformation._ws);
 //BA.debugLineNum = 4;BA.debugLine="Private divlist As JQueryElement";
customersinformation._divlist = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divlist",customersinformation._divlist);
 //BA.debugLineNum = 5;BA.debugLine="Private lblusernamemain As JQueryElement";
customersinformation._lblusernamemain = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_lblusernamemain",customersinformation._lblusernamemain);
 //BA.debugLineNum = 6;BA.debugLine="Private divMenu As JQueryElement";
customersinformation._divmenu = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divmenu",customersinformation._divmenu);
 //BA.debugLineNum = 10;BA.debugLine="Private IntIsMobileDev As Int";
customersinformation._intismobiledev = RemoteObject.createImmutable(0);__ref.setField("_intismobiledev",customersinformation._intismobiledev);
 //BA.debugLineNum = 11;BA.debugLine="Private divismobiledev As JQueryElement";
customersinformation._divismobiledev = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divismobiledev",customersinformation._divismobiledev);
 //BA.debugLineNum = 12;BA.debugLine="Private sql1 As SQL";
customersinformation._sql1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL");__ref.setField("_sql1",customersinformation._sql1);
 //BA.debugLineNum = 14;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _delete_button_table(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("Delete_button_table (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,138);
if (RapidSub.canDelegate("delete_button_table")) { return __ref.runUserSub(false, "customersinformation","delete_button_table", __ref, _params);}
...
customersinformation.__c.runVoidMethod ("LogImpl","23407873",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 143;BA.debugLine="sql1.ExecNonQuery(\"delete from CustomersInformati";
Debug.ShouldStop(16384);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("delete from CustomersInformation where CustomerID="),_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val")))))));
...
try {
		Debug.PushSubsStack("Edit_button_table (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,129);
if (RapidSub.canDelegate("edit_button_table")) { return __ref.runUserSub(false, "customersinformation","edit_button_table", __ref, _params);}
Debug.locals.put("params", _params);
...
Debug.ShouldStop(2);
customersinformation.__c.runVoidMethod ("LogImpl","23342337",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
__ref.getField(false,"_ws" /*RemoteObject*/ ).runMethod(false,"getSession").runVoidMethod ("SetAttribute",(Object)(BA.ObjectToString("CustomerID")),(Object)(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))));
 BA.debugLineNum = 134;BA.debugLine="ws.Eval(\"document.location.replace('AddCustomerIn";
Debug.ShouldStop(32);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(BA.ObjectToString("document.location.replace('AddCustomerInfo.html')")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), customersinformation.__c.getField(false,"Null")));
...
try {
		Debug.PushSubsStack("Initialize (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,16);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "customersinformation","initialize", __ref, _ba);}
...
try {
		Debug.PushSubsStack("Load_Data (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,40);
if (RapidSub.canDelegate("load_data")) { return __ref.runUserSub(false, "customersinformation","load_data", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
_cursor = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("Cursor", _cursor);
 BA.debugLineNum = 61;BA.debugLine="Cursor = sql1.ExecQuery(\"select * from Customers";
Debug.ShouldStop(268435456);
_cursor = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.createImmutable("select * from CustomersInformation")));Debug.locals.put("Cursor", _cursor);
...
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <tr> "));Debug.locals.put("str", _str);
 BA.debugLineNum = 66;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"CustomerI";
Debug.ShouldStop(2);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustomerID"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 67;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"CustomerN";
Debug.ShouldStop(4);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustomerName"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 68;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"CustEmail";
Debug.ShouldStop(8);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustEmail"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 69;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"CustPhone";
Debug.ShouldStop(16);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustPhone"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 70;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"CustCount";
Debug.ShouldStop(32);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustCountry"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 71;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"CustCity\"";
Debug.ShouldStop(64);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustCity"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 73;BA.debugLine="str = str & \"  <td style=' vertical-align: midd";
Debug.ShouldStop(256);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <td style=' vertical-align: middle !important; white-space: nowrap !important; '> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' onclick=\"editTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("CustomerID"))),RemoteObject.createImmutable(")\" class='btn btn-primary btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-pencil'></i></div></a> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' class='btn btn-danger btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-trash' onclick=\"deleteTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("CustomerID"))),RemoteObject.createImmutable(")\"></i></div></a> "),RemoteObject.createImmutable(" </td> </tr>"));Debug.locals.put("str", _str);
 }
;
...
Debug.ShouldStop(1);
_cursor = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("Cursor", _cursor);
 BA.debugLineNum = 98;BA.debugLine="Cursor = sql1.ExecQuery(\"select * from Customer";
Debug.ShouldStop(2);
_cursor = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.createImmutable("select * from CustomersInformation")));Debug.locals.put("Cursor", _cursor);
...
Debug.ShouldStop(32);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <tr> "));Debug.locals.put("str", _str);
 BA.debugLineNum = 103;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"Customer";
Debug.ShouldStop(64);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustomerID"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
 BA.debugLineNum = 104;BA.debugLine="str = str & \"<td>\"& Cursor.GetString(\"Customer";
Debug.ShouldStop(128);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("CustomerName"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
...
Debug.ShouldStop(134217728);
customersinformation.__c.runVoidMethod ("LogImpl","23276884",BA.ObjectToString(customersinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,150);
if (RapidSub.canDelegate("load_datatable_controls")) { return __ref.runUserSub(false, "customersinformation","load_datatable_controls", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
Debug.ShouldStop(16384);
customersinformation.__c.runVoidMethod ("LogImpl","23473433",BA.ObjectToString(customersinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("WebSocket_Connected (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,20);
if (RapidSub.canDelegate("websocket_connected")) { return __ref.runUserSub(false, "customersinformation","websocket_connected", __ref, _websocket1);}
...
Debug.ShouldStop(2097152);
customersinformation._main.runVoidMethod ("_validateusers" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_lblusernamemain" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_divmenu" /*RemoteObject*/ )));
...
Debug.ShouldStop(16777216);
__ref.setField ("_sql1" /*RemoteObject*/ ,customersinformation._main._pool /*RemoteObject*/ .runMethod(false,"GetConnection"));
 BA.debugLineNum = 27;BA.debugLine="CheckIsMobileBrowser";
Debug.ShouldStop(67108864);
__ref.runClassMethod (b4j.example.customersinformation.class, "_checkismobilebrowser" /*RemoteObject*/ );
 BA.debugLineNum = 30;BA.debugLine="Load_Data";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.customersinformation.class, "_load_data" /*RemoteObject*/ );
 BA.debugLineNum = 31;BA.debugLine="Load_Datatable_Controls";
Debug.ShouldStop(1073741824);
__ref.runClassMethod (b4j.example.customersinformation.class, "_load_datatable_controls" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (customersinformation) ","customersinformation",4,__ref.getField(false, "ba"),__ref,34);
if (RapidSub.canDelegate("websocket_disconnected")) { return __ref.runUserSub(false, "customersinformation","websocket_disconnected", __ref);}
