...
public class returnpurchaseinformation_subs_0 {


public static RemoteObject  _checkismobilebrowser(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("CheckIsMobileBrowser (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,185);
if (RapidSub.canDelegate("checkismobilebrowser")) { return __ref.runUserSub(false, "returnpurchaseinformation","checkismobilebrowser", __ref);}
...
Debug.ShouldStop(32);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(_str),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), returnpurchaseinformation.__c.getField(false,"Null")));
...
returnpurchaseinformation.__c.runVoidMethod ("LogImpl","218808848",BA.NumberToString(__ref.getField(true,"_intismobiledev" /*RemoteObject*/ )),0);
...
returnpurchaseinformation.__c.runVoidMethod ("LogImpl","218808850",BA.ObjectToString(returnpurchaseinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
returnpurchaseinformation._ws = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket");__ref.setField("_ws",returnpurchaseinformation._ws);
 //BA.debugLineNum = 4;BA.debugLine="Private divlist As JQueryElement";
returnpurchaseinformation._divlist = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divlist",returnpurchaseinformation._divlist);
 //BA.debugLineNum = 5;BA.debugLine="Private lblusernamemain As JQueryElement";
returnpurchaseinformation._lblusernamemain = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_lblusernamemain",returnpurchaseinformation._lblusernamemain);
 //BA.debugLineNum = 6;BA.debugLine="Private divMenu As JQueryElement";
returnpurchaseinformation._divmenu = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divmenu",returnpurchaseinformation._divmenu);
 //BA.debugLineNum = 9;BA.debugLine="Private IntIsMobileDev As Int";
returnpurchaseinformation._intismobiledev = RemoteObject.createImmutable(0);__ref.setField("_intismobiledev",returnpurchaseinformation._intismobiledev);
 //BA.debugLineNum = 10;BA.debugLine="Private divismobiledev As JQueryElement";
returnpurchaseinformation._divismobiledev = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divismobiledev",returnpurchaseinformation._divismobiledev);
 //BA.debugLineNum = 11;BA.debugLine="Private sql1 As SQL";
returnpurchaseinformation._sql1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL");__ref.setField("_sql1",returnpurchaseinformation._sql1);
 //BA.debugLineNum = 13;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _delete_button_table(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("Delete_button_table (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,134);
if (RapidSub.canDelegate("delete_button_table")) { return __ref.runUserSub(false, "returnpurchaseinformation","delete_button_table", __ref, _params);}
...
Debug.ShouldStop(64);
returnpurchaseinformation.__c.runVoidMethod ("LogImpl","218612225",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("BeginTransaction");
 BA.debugLineNum = 139;BA.debugLine="sql1.ExecNonQuery(\"delete from InvoiceH where Inv";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("Edit_button_table (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,125);
if (RapidSub.canDelegate("edit_button_table")) { return __ref.runUserSub(false, "returnpurchaseinformation","edit_button_table", __ref, _params);}
Debug.locals.put("params", _params);
...
returnpurchaseinformation.__c.runVoidMethod ("LogImpl","218546689",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
try {
		Debug.PushSubsStack("Initialize (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,15);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "returnpurchaseinformation","initialize", __ref, _ba);}
...
try {
		Debug.PushSubsStack("Load_Data (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,38);
if (RapidSub.canDelegate("load_data")) { return __ref.runUserSub(false, "returnpurchaseinformation","load_data", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
_cursor = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("Cursor", _cursor);
 BA.debugLineNum = 58;BA.debugLine="Cursor = sql1.ExecQuery($\"SELECT        ReturnPu";
Debug.ShouldStop(33554432);
_cursor = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)((RemoteObject.concat(RemoteObject.createImmutable("SELECT        ReturnPurchaseInvoiceH.ReturnPurchaseInvoiceHID, ReturnPurchaseInvoiceH.InvDT, ReturnPurchaseInvoiceH.InvTotal, ReturnPurchaseInvoiceH.InvTotalTax, ReturnPurchaseInvoiceH.InvTotalDiscount, ReturnPurchaseInvoiceH.InvTotalShipping, \n"),RemoteObject.createImmutable("                         ReturnPurchaseInvoiceH.PaidAmount, ReturnPurchaseInvoiceH.StrNotes, ReturnPurchaseInvoiceH.SupplierID, SuppliersInfo.SupplierName\n"),RemoteObject.createImmutable("FROM            ReturnPurchaseInvoiceH LEFT OUTER JOIN\n"),RemoteObject.createImmutable("                         SuppliersInfo ON ReturnPurchaseInvoiceH.SupplierID = SuppliersInfo.SupplierID")))));Debug.locals.put("Cursor", _cursor);
...
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <tr> "));Debug.locals.put("str", _str);
 BA.debugLineNum = 66;BA.debugLine="str = str & \"<td>\"& Cursor.GetInt(\"ReturnPurcha";
Debug.ShouldStop(2);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("ReturnPurchaseInvoiceHID"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
...
Debug.ShouldStop(64);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <td style=' vertical-align: middle !important; white-space: nowrap !important; '> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' onclick=\"editTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("ReturnPurchaseInvoiceHID"))),RemoteObject.createImmutable(")\" class='btn btn-primary btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-pencil' ></i></div></a> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' onclick=\"deleteTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("ReturnPurchaseInvoiceHID"))),RemoteObject.createImmutable(")\" class='btn btn-danger btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-trash' ></i></div></a> "),RemoteObject.createImmutable(" </td> </tr>"));Debug.locals.put("str", _str);
 }
;
...
Debug.ShouldStop(134217728);
_cursor = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("Cursor", _cursor);
 BA.debugLineNum = 93;BA.debugLine="Cursor = sql1.ExecQuery($\"SELECT        Return";
Debug.ShouldStop(268435456);
_cursor = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)((RemoteObject.concat(RemoteObject.createImmutable("SELECT        ReturnPurchaseInvoiceH.ReturnPurchaseInvoiceHID, ReturnPurchaseInvoiceH.InvDT, ReturnPurchaseInvoiceH.InvTotal, ReturnPurchaseInvoiceH.InvTotalTax, ReturnPurchaseInvoiceH.InvTotalDiscount, ReturnPurchaseInvoiceH.InvTotalShipping, \n"),RemoteObject.createImmutable("                         ReturnPurchaseInvoiceH.PaidAmount, ReturnPurchaseInvoiceH.StrNotes, ReturnPurchaseInvoiceH.SupplierID, SuppliersInfo.SupplierName\n"),RemoteObject.createImmutable("FROM            ReturnPurchaseInvoiceH LEFT OUTER JOIN\n"),RemoteObject.createImmutable("                         SuppliersInfo ON ReturnPurchaseInvoiceH.SupplierID = SuppliersInfo.SupplierID")))));Debug.locals.put("Cursor", _cursor);
...
Debug.ShouldStop(8);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <tr> "));Debug.locals.put("str", _str);
 BA.debugLineNum = 101;BA.debugLine="str = str & \"<td>\"& Cursor.GetInt(\"ReturnPurc";
Debug.ShouldStop(16);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("ReturnPurchaseInvoiceHID"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
...
Debug.ShouldStop(16777216);
returnpurchaseinformation.__c.runVoidMethod ("LogImpl","218481235",BA.ObjectToString(returnpurchaseinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,155);
if (RapidSub.canDelegate("load_datatable_controls")) { return __ref.runUserSub(false, "returnpurchaseinformation","load_datatable_controls", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
returnpurchaseinformation.__c.runVoidMethod ("LogImpl","218743321",BA.ObjectToString(returnpurchaseinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Print_Table_Data (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,146);
if (RapidSub.canDelegate("print_table_data")) { return __ref.runUserSub(false, "returnpurchaseinformation","print_table_data", __ref, _params);}
Debug.locals.put("params", _params);
...
Debug.ShouldStop(262144);
returnpurchaseinformation.__c.runVoidMethod ("LogImpl","218677761",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
try {
		Debug.PushSubsStack("WebSocket_Connected (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,19);
if (RapidSub.canDelegate("websocket_connected")) { return __ref.runUserSub(false, "returnpurchaseinformation","websocket_connected", __ref, _websocket1);}
...
Debug.ShouldStop(1048576);
returnpurchaseinformation._main.runVoidMethod ("_validateusers" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_lblusernamemain" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_divmenu" /*RemoteObject*/ )));
...
__ref.setField ("_sql1" /*RemoteObject*/ ,returnpurchaseinformation._main._pool /*RemoteObject*/ .runMethod(false,"GetConnection"));
 BA.debugLineNum = 26;BA.debugLine="CheckIsMobileBrowser";
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4j.example.returnpurchaseinformation.class, "_checkismobilebrowser" /*RemoteObject*/ );
 BA.debugLineNum = 28;BA.debugLine="Load_Data";
Debug.ShouldStop(134217728);
__ref.runClassMethod (b4j.example.returnpurchaseinformation.class, "_load_data" /*RemoteObject*/ );
 BA.debugLineNum = 29;BA.debugLine="Load_Datatable_Controls";
Debug.ShouldStop(268435456);
__ref.runClassMethod (b4j.example.returnpurchaseinformation.class, "_load_datatable_controls" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (returnpurchaseinformation) ","returnpurchaseinformation",29,__ref.getField(false, "ba"),__ref,32);
if (RapidSub.canDelegate("websocket_disconnected")) { return __ref.runUserSub(false, "returnpurchaseinformation","websocket_disconnected", __ref);}
