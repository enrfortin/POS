...
public class addreturnpurchaseinfo {
    public static RemoteObject myClass;
	public addreturnpurchaseinfo() {
	}
    public static PCBA staticBA = new PCBA(null, addreturnpurchaseinfo.class);
...
public static RemoteObject _cmbsupplier = RemoteObject.declareNull("anywheresoftware.b4j.object.WebSocket.JQueryElement");
