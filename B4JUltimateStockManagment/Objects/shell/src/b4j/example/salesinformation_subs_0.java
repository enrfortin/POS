...
public class salesinformation_subs_0 {


public static RemoteObject  _checkismobilebrowser(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("CheckIsMobileBrowser (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,189);
if (RapidSub.canDelegate("checkismobilebrowser")) { return __ref.runUserSub(false, "salesinformation","checkismobilebrowser", __ref);}
...
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(_str),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), salesinformation.__c.getField(false,"Null")));
...
salesinformation.__c.runVoidMethod ("LogImpl","220119568",BA.NumberToString(__ref.getField(true,"_intismobiledev" /*RemoteObject*/ )),0);
...
salesinformation.__c.runVoidMethod ("LogImpl","220119570",BA.ObjectToString(salesinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
salesinformation._ws = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket");__ref.setField("_ws",salesinformation._ws);
 //BA.debugLineNum = 4;BA.debugLine="Private divlist As JQueryElement";
salesinformation._divlist = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divlist",salesinformation._divlist);
 //BA.debugLineNum = 5;BA.debugLine="Private lblusernamemain As JQueryElement";
salesinformation._lblusernamemain = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_lblusernamemain",salesinformation._lblusernamemain);
 //BA.debugLineNum = 6;BA.debugLine="Private divMenu As JQueryElement";
salesinformation._divmenu = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divmenu",salesinformation._divmenu);
 //BA.debugLineNum = 9;BA.debugLine="Private IntIsMobileDev As Int";
salesinformation._intismobiledev = RemoteObject.createImmutable(0);__ref.setField("_intismobiledev",salesinformation._intismobiledev);
 //BA.debugLineNum = 10;BA.debugLine="Private divismobiledev As JQueryElement";
salesinformation._divismobiledev = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divismobiledev",salesinformation._divismobiledev);
 //BA.debugLineNum = 11;BA.debugLine="Private sql1 As SQL";
salesinformation._sql1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL");__ref.setField("_sql1",salesinformation._sql1);
 //BA.debugLineNum = 13;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _delete_button_table(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("Delete_button_table (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,138);
if (RapidSub.canDelegate("delete_button_table")) { return __ref.runUserSub(false, "salesinformation","delete_button_table", __ref, _params);}
...
salesinformation.__c.runVoidMethod ("LogImpl","219922945",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
try {
		Debug.PushSubsStack("Edit_button_table (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,129);
if (RapidSub.canDelegate("edit_button_table")) { return __ref.runUserSub(false, "salesinformation","edit_button_table", __ref, _params);}
Debug.locals.put("params", _params);
...
Debug.ShouldStop(2);
salesinformation.__c.runVoidMethod ("LogImpl","219857409",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
__ref.getField(false,"_ws" /*RemoteObject*/ ).runMethod(false,"getSession").runVoidMethod ("SetAttribute",(Object)(BA.ObjectToString("InvoiceID")),(Object)(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))));
 BA.debugLineNum = 134;BA.debugLine="ws.Eval(\"document.location.replace('AddSalesInfo.";
Debug.ShouldStop(32);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(BA.ObjectToString("document.location.replace('AddSalesInfo.html')")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), salesinformation.__c.getField(false,"Null")));
...
try {
		Debug.PushSubsStack("Initialize (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,15);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "salesinformation","initialize", __ref, _ba);}
...
try {
		Debug.PushSubsStack("Load_Data (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,38);
if (RapidSub.canDelegate("load_data")) { return __ref.runUserSub(false, "salesinformation","load_data", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
_cursor = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("Cursor", _cursor);
 BA.debugLineNum = 59;BA.debugLine="Cursor = sql1.ExecQuery($\"SELECT        SalesInv";
Debug.ShouldStop(67108864);
_cursor = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)((RemoteObject.concat(RemoteObject.createImmutable("SELECT        SalesInvoiceH.SalesInvoiceHID, SalesInvoiceH.InvDT, SalesInvoiceH.InvTotal, SalesInvoiceH.UserID, SalesInvoiceH.InvTotalTax, SalesInvoiceH.InvTotalDiscount, SalesInvoiceH.InvTotalShipping, \n"),RemoteObject.createImmutable("                         SalesInvoiceH.PaidAmount, SalesInvoiceH.StrNotes, SalesInvoiceH.PaymenttypeID, SalesInvoiceH.CustomerID, CustomersInformation.CustomerName, UsersInformation.UserFullName\n"),RemoteObject.createImmutable("FROM            SalesInvoiceH LEFT OUTER JOIN\n"),RemoteObject.createImmutable("                         CustomersInformation ON SalesInvoiceH.CustomerID = CustomersInformation.CustomerID LEFT OUTER JOIN\n"),RemoteObject.createImmutable("                         UsersInformation ON SalesInvoiceH.UserID = UsersInformation.UserID")))));Debug.locals.put("Cursor", _cursor);
...
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <tr> "));Debug.locals.put("str", _str);
 BA.debugLineNum = 68;BA.debugLine="str = str & \"<td>\"& Cursor.GetInt(\"SalesInvoice";
Debug.ShouldStop(8);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("SalesInvoiceHID"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
...
Debug.ShouldStop(512);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <td style=' vertical-align: middle !important; white-space: nowrap !important; '> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' onclick=\"editTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("SalesInvoiceHID"))),RemoteObject.createImmutable(")\" class='btn btn-primary btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-pencil' ></i></div></a> "),RemoteObject.createImmutable(" <a href='javascript:void(0);' onclick=\"deleteTbl("),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("SalesInvoiceHID"))),RemoteObject.createImmutable(")\" class='btn btn-danger btn-icon mg-r-5 mg-b-10'><div><i class='fa fa-trash' ></i></div></a> "),RemoteObject.createImmutable(" </td> </tr>"));Debug.locals.put("str", _str);
 }
;
...
Debug.ShouldStop(1073741824);
_cursor = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("Cursor", _cursor);
 BA.debugLineNum = 96;BA.debugLine="Cursor = sql1.ExecQuery($\"SELECT        SalesI";
Debug.ShouldStop(-2147483648);
_cursor = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)((RemoteObject.concat(RemoteObject.createImmutable("SELECT        SalesInvoiceH.SalesInvoiceHID, SalesInvoiceH.InvDT, SalesInvoiceH.InvTotal, SalesInvoiceH.UserID, SalesInvoiceH.InvTotalTax, SalesInvoiceH.InvTotalDiscount, SalesInvoiceH.InvTotalShipping, \n"),RemoteObject.createImmutable("                         SalesInvoiceH.PaidAmount, SalesInvoiceH.StrNotes, SalesInvoiceH.PaymenttypeID, SalesInvoiceH.CustomerID, CustomersInformation.CustomerName, UsersInformation.UserFullName\n"),RemoteObject.createImmutable("FROM            SalesInvoiceH LEFT OUTER JOIN\n"),RemoteObject.createImmutable("                         CustomersInformation ON SalesInvoiceH.CustomerID = CustomersInformation.CustomerID LEFT OUTER JOIN\n"),RemoteObject.createImmutable("                         UsersInformation ON SalesInvoiceH.UserID = UsersInformation.UserID")))));Debug.locals.put("Cursor", _cursor);
...
Debug.ShouldStop(128);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("  <tr> "));Debug.locals.put("str", _str);
 BA.debugLineNum = 105;BA.debugLine="str = str & \"<td>\"& Cursor.GetInt(\"SalesInvoi";
Debug.ShouldStop(256);
_str = RemoteObject.concat(_str,RemoteObject.createImmutable("<td>"),_cursor.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("SalesInvoiceHID"))),RemoteObject.createImmutable("</td>"));Debug.locals.put("str", _str);
...
Debug.ShouldStop(268435456);
salesinformation.__c.runVoidMethod ("LogImpl","219791959",BA.ObjectToString(salesinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,159);
if (RapidSub.canDelegate("load_datatable_controls")) { return __ref.runUserSub(false, "salesinformation","load_datatable_controls", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
...
salesinformation.__c.runVoidMethod ("LogImpl","220054041",BA.ObjectToString(salesinformation.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Print_Table_Data (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,150);
if (RapidSub.canDelegate("print_table_data")) { return __ref.runUserSub(false, "salesinformation","print_table_data", __ref, _params);}
Debug.locals.put("params", _params);
...
salesinformation.__c.runVoidMethod ("LogImpl","219988481",BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("val"))))),0);
...
try {
		Debug.PushSubsStack("WebSocket_Connected (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,19);
if (RapidSub.canDelegate("websocket_connected")) { return __ref.runUserSub(false, "salesinformation","websocket_connected", __ref, _websocket1);}
...
Debug.ShouldStop(1048576);
salesinformation._main.runVoidMethod ("_validateusers" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_lblusernamemain" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_divmenu" /*RemoteObject*/ )));
...
Debug.ShouldStop(8388608);
__ref.setField ("_sql1" /*RemoteObject*/ ,salesinformation._main._pool /*RemoteObject*/ .runMethod(false,"GetConnection"));
 BA.debugLineNum = 26;BA.debugLine="CheckIsMobileBrowser";
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4j.example.salesinformation.class, "_checkismobilebrowser" /*RemoteObject*/ );
 BA.debugLineNum = 28;BA.debugLine="Load_Data";
Debug.ShouldStop(134217728);
__ref.runClassMethod (b4j.example.salesinformation.class, "_load_data" /*RemoteObject*/ );
 BA.debugLineNum = 29;BA.debugLine="Load_Datatable_Controls";
Debug.ShouldStop(268435456);
__ref.runClassMethod (b4j.example.salesinformation.class, "_load_datatable_controls" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (salesinformation) ","salesinformation",31,__ref.getField(false, "ba"),__ref,32);
if (RapidSub.canDelegate("websocket_disconnected")) { return __ref.runUserSub(false, "salesinformation","websocket_disconnected", __ref);}
