...
public class addsalesinfo_subs_0 {


public static RemoteObject  _btnaddproduct_click(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("btnaddproduct_Click (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,141);
if (RapidSub.canDelegate("btnaddproduct_click")) { return __ref.runUserSub(false, "addsalesinfo","btnaddproduct_click", __ref, _params);}
...
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_addedproducts_temp" /*RemoteObject*/ );
...
addsalesinfo.__c.runVoidMethod ("LogImpl","211403282",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("btncancel_Click (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,402);
if (RapidSub.canDelegate("btncancel_click")) { return __ref.runUserSub(false, "addsalesinfo","btncancel_click", __ref, _params);}
Debug.locals.put("Params", _params);
...
try {
		Debug.PushSubsStack("btnsave_Click (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,247);
if (RapidSub.canDelegate("btnsave_click")) { return __ref.runUserSub(false, "addsalesinfo","btnsave_click", __ref, _params);}
...
Debug.ShouldStop(536870912);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)((RemoteObject.concat(RemoteObject.createImmutable("UPDATE SalesInvoiceH\n"),RemoteObject.createImmutable("				   SET InvDT = ?\n"),RemoteObject.createImmutable("				      ,InvTotal = ?\n"),RemoteObject.createImmutable("				      ,UserID = ?\n"),RemoteObject.createImmutable("				      ,InvTotalTax = ?\n"),RemoteObject.createImmutable("				      ,InvTotalDiscount = ?\n"),RemoteObject.createImmutable("				      ,InvTotalShipping = ?\n"),RemoteObject.createImmutable("				      ,PaidAmount = ?\n"),RemoteObject.createImmutable("				      ,StrNotes = ?\n"),RemoteObject.createImmutable("				      ,PaymenttypeID = ?\n"),RemoteObject.createImmutable("				      ,CustomerID = ?\n"),RemoteObject.createImmutable("				 WHERE SalesInvoiceHID=?")))),(Object)(addsalesinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {11},new Object[] {__ref.getField(false,"_txtinvdate" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_dblinvtotal),__ref.getField(false,"_cmbuser" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_dblinvtotaltax),(_dblinvtotaldiscount),RemoteObject.createImmutable((0)),RemoteObject.createImmutable((0)),__ref.getField(false,"_txtinvnote" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),__ref.getField(false,"_cmbpaymenttype" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),__ref.getField(false,"_cmbcustomer" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_invoiceid)})))));
...
Debug.ShouldStop(8192);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)(BA.ObjectToString("delete from SalesInvoiceD where SalesInvoiceHID=?")),(Object)(addsalesinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_invoiceid)})))));
...
Debug.ShouldStop(16384);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)((RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO SalesInvoiceH\n"),RemoteObject.createImmutable("				           (InvDT\n"),RemoteObject.createImmutable("				           ,InvTotal\n"),RemoteObject.createImmutable("				           ,UserID\n"),RemoteObject.createImmutable("				           ,InvTotalTax\n"),RemoteObject.createImmutable("				           ,InvTotalDiscount\n"),RemoteObject.createImmutable("				           ,InvTotalShipping\n"),RemoteObject.createImmutable("				           ,PaidAmount\n"),RemoteObject.createImmutable("				           ,StrNotes\n"),RemoteObject.createImmutable("				           ,PaymenttypeID\n"),RemoteObject.createImmutable("				           ,CustomerID)\n"),RemoteObject.createImmutable("				     VALUES\n"),RemoteObject.createImmutable("				           (?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?\n"),RemoteObject.createImmutable("				           ,?)")))),(Object)(addsalesinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {10},new Object[] {__ref.getField(false,"_txtinvdate" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_dblinvtotal),__ref.getField(false,"_cmbuser" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),(_dblinvtotaltax),(_dblinvtotaldiscount),RemoteObject.createImmutable((0)),RemoteObject.createImmutable((0)),__ref.getField(false,"_txtinvnote" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),__ref.getField(false,"_cmbpaymenttype" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue"),__ref.getField(false,"_cmbcustomer" /*RemoteObject*/ ).runMethod(false,"GetVal").runMethod(false,"getValue")})))));
...
Debug.ShouldStop(524288);
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery2",(Object)((RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO SalesInvoiceD\n"),RemoteObject.createImmutable("					           (SalesInvoiceHID\n"),RemoteObject.createImmutable("					           ,ProductID\n"),RemoteObject.createImmutable("					           ,ProductSellPrice\n"),RemoteObject.createImmutable("					           ,ProductCostPrice\n"),RemoteObject.createImmutable("					           ,TaxPerc\n"),RemoteObject.createImmutable("					           ,ProductQty)\n"),RemoteObject.createImmutable("					     VALUES\n"),RemoteObject.createImmutable("					           (?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?\n"),RemoteObject.createImmutable("					           ,?)")))),(Object)(addsalesinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {6},new Object[] {(_lastsavedid),(_classtempprod.getField(true,"_productid" /*RemoteObject*/ )),(_classtempprod.getField(true,"_unitprice" /*RemoteObject*/ )),(_classtempprod.getField(true,"_productcostprice" /*RemoteObject*/ )),(_classtempprod.getField(true,"_taxid" /*RemoteObject*/ )),(_classtempprod.getField(true,"_qty" /*RemoteObject*/ ))})))));
...
Debug.ShouldStop(256);
addsalesinfo._main.runVoidMethod ("_insert_userslogs" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("Invoice Information")));
...
Debug.ShouldStop(16384);
addsalesinfo.__c.runVoidMethod ("LogImpl","211665560",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
addsalesinfo._ws = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket");__ref.setField("_ws",addsalesinfo._ws);
 //BA.debugLineNum = 5;BA.debugLine="Private txtinvdate,cmbcustomer,cmbuser,txtinvnote";
addsalesinfo._txtinvdate = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtinvdate",addsalesinfo._txtinvdate);
addsalesinfo._cmbcustomer = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_cmbcustomer",addsalesinfo._cmbcustomer);
addsalesinfo._cmbuser = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_cmbuser",addsalesinfo._cmbuser);
addsalesinfo._txtinvnote = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtinvnote",addsalesinfo._txtinvnote);
addsalesinfo._cmbproduct = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_cmbproduct",addsalesinfo._cmbproduct);
addsalesinfo._txttax = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txttax",addsalesinfo._txttax);
addsalesinfo._txtunitprice = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtunitprice",addsalesinfo._txtunitprice);
addsalesinfo._txtqty = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtqty",addsalesinfo._txtqty);
addsalesinfo._txtdiscount = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_txtdiscount",addsalesinfo._txtdiscount);
addsalesinfo._btnaddproduct = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_btnaddproduct",addsalesinfo._btnaddproduct);
addsalesinfo._btnsave = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_btnsave",addsalesinfo._btnsave);
addsalesinfo._btncancel = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_btncancel",addsalesinfo._btncancel);
addsalesinfo._divproducts = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divproducts",addsalesinfo._divproducts);
addsalesinfo._cmbpaymenttype = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_cmbpaymenttype",addsalesinfo._cmbpaymenttype);
 //BA.debugLineNum = 7;BA.debugLine="Private TempProductsTable As List";
addsalesinfo._tempproductstable = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_tempproductstable",addsalesinfo._tempproductstable);
 //BA.debugLineNum = 9;BA.debugLine="Private templistcmbcustomer As List";
addsalesinfo._templistcmbcustomer = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_templistcmbcustomer",addsalesinfo._templistcmbcustomer);
 //BA.debugLineNum = 10;BA.debugLine="Private templistpaymenttype As List";
addsalesinfo._templistpaymenttype = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_templistpaymenttype",addsalesinfo._templistpaymenttype);
 //BA.debugLineNum = 11;BA.debugLine="Private lblusernamemain As JQueryElement";
addsalesinfo._lblusernamemain = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_lblusernamemain",addsalesinfo._lblusernamemain);
 //BA.debugLineNum = 12;BA.debugLine="Private divMenu As JQueryElement";
addsalesinfo._divmenu = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket.JQueryElement");__ref.setField("_divmenu",addsalesinfo._divmenu);
 //BA.debugLineNum = 13;BA.debugLine="Private sql1 As SQL";
addsalesinfo._sql1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL");__ref.setField("_sql1",addsalesinfo._sql1);
 //BA.debugLineNum = 15;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _cmbproduct_change(RemoteObject __ref,RemoteObject _params) throws Exception{
try {
		Debug.PushSubsStack("cmbproduct_Change (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,163);
if (RapidSub.canDelegate("cmbproduct_change")) { return __ref.runUserSub(false, "addsalesinfo","cmbproduct_change", __ref, _params);}
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
Debug.locals.put("Params", _params);
...
Debug.ShouldStop(4096);
addsalesinfo.__c.runVoidMethod ("LogImpl","211468810",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Delete_button_table_Products (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,235);
if (RapidSub.canDelegate("delete_button_table_products")) { return __ref.runUserSub(false, "addsalesinfo","delete_button_table_products", __ref, _params);}
...
try {
		Debug.PushSubsStack("Initialize (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,17);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "addsalesinfo","initialize", __ref, _ba);}
...
try {
		Debug.PushSubsStack("Load_AddedProducts_Temp (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,177);
if (RapidSub.canDelegate("load_addedproducts_temp")) { return __ref.runUserSub(false, "addsalesinfo","load_addedproducts_temp", __ref);}
...
Debug.ShouldStop(8);
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_datatable_controls" /*RemoteObject*/ );
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e27) {
...
Debug.ShouldStop(64);
addsalesinfo.__c.runVoidMethod ("LogImpl","211534390",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Customer (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,50);
if (RapidSub.canDelegate("load_customer")) { return __ref.runUserSub(false, "addsalesinfo","load_customer", __ref);}
...
Debug.ShouldStop(8);
addsalesinfo.__c.runVoidMethod ("LogImpl","211141138",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Data_ByID (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,408);
if (RapidSub.canDelegate("load_data_byid")) { return __ref.runUserSub(false, "addsalesinfo","load_data_byid", __ref);}
RemoteObject _invoiceid = RemoteObject.createImmutable(0);
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
RemoteObject _strid = RemoteObject.createImmutable("");
RemoteObject _classtempprod = RemoteObject.declareNull("b4j.example.clstempproducts");
 BA.debugLineNum = 408;BA.debugLine="Sub Load_Data_ByID";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 409;BA.debugLine="Try";
Debug.ShouldStop(16777216);
try { BA.debugLineNum = 411;BA.debugLine="Dim InvoiceID As Int = 0";
Debug.ShouldStop(67108864);
_invoiceid = BA.numberCast(int.class, 0);Debug.locals.put("InvoiceID", _invoiceid);Debug.locals.put("InvoiceID", _invoiceid);
 BA.debugLineNum = 412;BA.debugLine="If ws.Session.GetAttribute(\"InvoiceID\") = Null T";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("n",__ref.getField(false,"_ws" /*RemoteObject*/ ).runMethod(false,"getSession").runMethod(false,"GetAttribute",(Object)(RemoteObject.createImmutable("InvoiceID"))))) { 
 }else {
 BA.debugLineNum = 415;BA.debugLine="InvoiceID = ws.Session.GetAttribute(\"InvoiceID\"";
Debug.ShouldStop(1073741824);
_invoiceid = BA.numberCast(int.class, __ref.getField(false,"_ws" /*RemoteObject*/ ).runMethod(false,"getSession").runMethod(false,"GetAttribute",(Object)(RemoteObject.createImmutable("InvoiceID"))));Debug.locals.put("InvoiceID", _invoiceid);
 };
 BA.debugLineNum = 418;BA.debugLine="If InvoiceID > 0 Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean(">",_invoiceid,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 420;BA.debugLine="Dim rs As ResultSet";
Debug.ShouldStop(8);
_rs = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("rs", _rs);
 BA.debugLineNum = 421;BA.debugLine="rs = sql1.ExecQuery(\"select * from SalesInvoice";
Debug.ShouldStop(16);
_rs = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("select * from SalesInvoiceH where SalesInvoiceHID="),_invoiceid)));Debug.locals.put("rs", _rs);
 BA.debugLineNum = 422;BA.debugLine="Do While rs.NextRow";
Debug.ShouldStop(32);
while (_rs.runMethod(true,"NextRow").<Boolean>get().booleanValue()) {
 BA.debugLineNum = 424;BA.debugLine="txtinvdate.SetVal(rs.GetString(\"InvDT\"))";
Debug.ShouldStop(128);
__ref.getField(false,"_txtinvdate" /*RemoteObject*/ ).runVoidMethod ("SetVal",(Object)((_rs.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("InvDT"))))));
 BA.debugLineNum = 425;BA.debugLine="txtinvnote.SetVal(rs.GetString(\"StrNotes\"))";
Debug.ShouldStop(256);
__ref.getField(false,"_txtinvnote" /*RemoteObject*/ ).runVoidMethod ("SetVal",(Object)((_rs.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("StrNotes"))))));
 BA.debugLineNum = 427;BA.debugLine="Dim strID As String = cmbcustomer.id";
Debug.ShouldStop(1024);
_strid = __ref.getField(false,"_cmbcustomer" /*RemoteObject*/ ).runMethod(true,"getId");Debug.locals.put("strID", _strid);Debug.locals.put("strID", _strid);
 BA.debugLineNum = 428;BA.debugLine="strID = strID.Replace(\"#\",\"\")";
Debug.ShouldStop(2048);
_strid = _strid.runMethod(true,"replace",(Object)(BA.ObjectToString("#")),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("strID", _strid);
 BA.debugLineNum = 429;BA.debugLine="ws.RunFunction(\"setSelectedRow\", Array As Obje";
Debug.ShouldStop(4096);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("RunFunction",(Object)(BA.ObjectToString("setSelectedRow")),(Object)(addsalesinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_strid),(_rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("CustomerID"))))})))));
 BA.debugLineNum = 432;BA.debugLine="Dim strID As String = cmbpaymenttype.id";
Debug.ShouldStop(32768);
_strid = __ref.getField(false,"_cmbpaymenttype" /*RemoteObject*/ ).runMethod(true,"getId");Debug.locals.put("strID", _strid);Debug.locals.put("strID", _strid);
 BA.debugLineNum = 433;BA.debugLine="strID = strID.Replace(\"#\",\"\")";
Debug.ShouldStop(65536);
_strid = _strid.runMethod(true,"replace",(Object)(BA.ObjectToString("#")),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("strID", _strid);
 BA.debugLineNum = 434;BA.debugLine="ws.RunFunction(\"setSelectedRow\", Array As Obje";
Debug.ShouldStop(131072);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("RunFunction",(Object)(BA.ObjectToString("setSelectedRow")),(Object)(addsalesinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_strid),(_rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("PaymenttypeID"))))})))));
 BA.debugLineNum = 436;BA.debugLine="Dim strID As String = cmbuser.id";
Debug.ShouldStop(524288);
_strid = __ref.getField(false,"_cmbuser" /*RemoteObject*/ ).runMethod(true,"getId");Debug.locals.put("strID", _strid);Debug.locals.put("strID", _strid);
 BA.debugLineNum = 437;BA.debugLine="strID = strID.Replace(\"#\",\"\")";
Debug.ShouldStop(1048576);
_strid = _strid.runMethod(true,"replace",(Object)(BA.ObjectToString("#")),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("strID", _strid);
 BA.debugLineNum = 438;BA.debugLine="ws.RunFunction(\"setSelectedRow\", Array As Obje";
Debug.ShouldStop(2097152);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("RunFunction",(Object)(BA.ObjectToString("setSelectedRow")),(Object)(addsalesinfo.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_strid),(_rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("UserID"))))})))));
 }
;
 BA.debugLineNum = 442;BA.debugLine="rs.Close";
Debug.ShouldStop(33554432);
_rs.runVoidMethod ("Close");
 BA.debugLineNum = 445;BA.debugLine="Dim rs As ResultSet";
Debug.ShouldStop(268435456);
_rs = RemoteObject.createNew ("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");Debug.locals.put("rs", _rs);
 BA.debugLineNum = 446;BA.debugLine="rs = sql1.ExecQuery(\"select * from SalesInvoice";
Debug.ShouldStop(536870912);
_rs = __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("select * from SalesInvoiceD where SalesInvoiceHID="),_invoiceid)));Debug.locals.put("rs", _rs);
 BA.debugLineNum = 447;BA.debugLine="Do While rs.NextRow";
Debug.ShouldStop(1073741824);
while (_rs.runMethod(true,"NextRow").<Boolean>get().booleanValue()) {
 BA.debugLineNum = 449;BA.debugLine="Dim ClassTempProd As ClsTempProducts";
Debug.ShouldStop(1);
_classtempprod = RemoteObject.createNew ("b4j.example.clstempproducts");Debug.locals.put("ClassTempProd", _classtempprod);
 BA.debugLineNum = 450;BA.debugLine="ClassTempProd.Initialize";
Debug.ShouldStop(2);
_classtempprod.runClassMethod (b4j.example.clstempproducts.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 451;BA.debugLine="ClassTempProd.SetValues(rs.GetInt(\"ProductID\")";
Debug.ShouldStop(4);
_classtempprod.runClassMethod (b4j.example.clstempproducts.class, "_setvalues" /*RemoteObject*/ ,(Object)(_rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("ProductID")))),(Object)(_rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("TaxPerc")))),(Object)(BA.numberCast(float.class, _rs.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("ProductSellPrice"))))),(Object)(_rs.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("ProductQty")))),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 453;BA.debugLine="TempProductsTable.Add(ClassTempProd)";
Debug.ShouldStop(16);
__ref.getField(false,"_tempproductstable" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_classtempprod)));
 BA.debugLineNum = 454;BA.debugLine="Load_AddedProducts_Temp";
Debug.ShouldStop(32);
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_addedproducts_temp" /*RemoteObject*/ );
 }
;
 BA.debugLineNum = 457;BA.debugLine="rs.Close";
Debug.ShouldStop(256);
_rs.runVoidMethod ("Close");
 };
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e36.toString()); BA.debugLineNum = 463;BA.debugLine="Log(LastException)";
Debug.ShouldStop(16384);
addsalesinfo.__c.runVoidMethod ("LogImpl","211796535",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,469);
if (RapidSub.canDelegate("load_datatable_controls")) { return __ref.runUserSub(false, "addsalesinfo","load_datatable_controls", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
 BA.debugLineNum = 469;BA.debugLine="Sub Load_Datatable_Controls";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 470;BA.debugLine="Try";
Debug.ShouldStop(2097152);
try { BA.debugLineNum = 472;BA.debugLine="Dim str As String";
Debug.ShouldStop(8388608);
_str = RemoteObject.createImmutable("");Debug.locals.put("str", _str);
 BA.debugLineNum = 473;BA.debugLine="str = $\" $(function(){         'use strict';";
Debug.ShouldStop(16777216);
_str = (RemoteObject.concat(RemoteObject.createImmutable(" $(function(){\n"),RemoteObject.createImmutable("        'use strict';\n"),RemoteObject.createImmutable("\n"),RemoteObject.createImmutable("        $('#datatable1').DataTable({\n"),RemoteObject.createImmutable("  bLengthChange: false,\n"),RemoteObject.createImmutable("  searching: false,\n"),RemoteObject.createImmutable("  responsive: true\n"),RemoteObject.createImmutable("});\n"),RemoteObject.createImmutable("\n"),RemoteObject.createImmutable("      });")));Debug.locals.put("str", _str);
 BA.debugLineNum = 484;BA.debugLine="ws.Eval(str,Null)";
Debug.ShouldStop(8);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(_str),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), addsalesinfo.__c.getField(false,"Null")));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e6.toString()); BA.debugLineNum = 487;BA.debugLine="Log(LastException)";
Debug.ShouldStop(64);
addsalesinfo.__c.runVoidMethod ("LogImpl","211862034",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Datatable_Controls2 (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,491);
if (RapidSub.canDelegate("load_datatable_controls2")) { return __ref.runUserSub(false, "addsalesinfo","load_datatable_controls2", __ref);}
RemoteObject _str = RemoteObject.createImmutable("");
 BA.debugLineNum = 491;BA.debugLine="Sub Load_Datatable_Controls2";
Debug.ShouldStop(1024);
 BA.debugLineNum = 492;BA.debugLine="Try";
Debug.ShouldStop(2048);
try { BA.debugLineNum = 494;BA.debugLine="Dim str As String";
Debug.ShouldStop(8192);
_str = RemoteObject.createImmutable("");Debug.locals.put("str", _str);
 BA.debugLineNum = 495;BA.debugLine="str = $\" $(function(){         'use strict';";
Debug.ShouldStop(16384);
_str = (RemoteObject.concat(RemoteObject.createImmutable(" $(function(){\n"),RemoteObject.createImmutable("        'use strict';\n"),RemoteObject.createImmutable("\n"),RemoteObject.createImmutable("        $('#datatable2').DataTable({\n"),RemoteObject.createImmutable("  bLengthChange: false,\n"),RemoteObject.createImmutable("  searching: false,\n"),RemoteObject.createImmutable("  responsive: true\n"),RemoteObject.createImmutable("});\n"),RemoteObject.createImmutable("      });")));Debug.locals.put("str", _str);
 BA.debugLineNum = 505;BA.debugLine="ws.Eval(str,Null)";
Debug.ShouldStop(16777216);
__ref.getField(false,"_ws" /*RemoteObject*/ ).runVoidMethod ("Eval",(Object)(_str),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), addsalesinfo.__c.getField(false,"Null")));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e6.toString()); BA.debugLineNum = 508;BA.debugLine="Log(LastException)";
Debug.ShouldStop(134217728);
addsalesinfo.__c.runVoidMethod ("LogImpl","211927569",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_PaymentTypes (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,73);
if (RapidSub.canDelegate("load_paymenttypes")) { return __ref.runUserSub(false, "addsalesinfo","load_paymenttypes", __ref);}
RemoteObject _sb = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
RemoteObject _val = RemoteObject.createImmutable("");
...
Debug.ShouldStop(67108864);
addsalesinfo.__c.runVoidMethod ("LogImpl","211206674",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_Products (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,120);
if (RapidSub.canDelegate("load_products")) { return __ref.runUserSub(false, "addsalesinfo","load_products", __ref);}
RemoteObject _sb = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
RemoteObject _val = RemoteObject.createImmutable("");
...
Debug.ShouldStop(64);
addsalesinfo.__c.runVoidMethod ("LogImpl","211337743",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Load_UsersInformation (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,96);
if (RapidSub.canDelegate("load_usersinformation")) { return __ref.runUserSub(false, "addsalesinfo","load_usersinformation", __ref);}
RemoteObject _sb = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
RemoteObject _rs = RemoteObject.declareNull("anywheresoftware.b4j.objects.SQL.ResultSetWrapper");
RemoteObject _val = RemoteObject.createImmutable("");
...
Debug.ShouldStop(32768);
addsalesinfo.__c.runVoidMethod ("LogImpl","211272208",BA.ObjectToString(addsalesinfo.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("WebSocket_Connected (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,21);
if (RapidSub.canDelegate("websocket_connected")) { return __ref.runUserSub(false, "addsalesinfo","websocket_connected", __ref, _websocket1);}
...
Debug.ShouldStop(4194304);
addsalesinfo._main.runVoidMethod ("_validateusers" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_ws" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_lblusernamemain" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_divmenu" /*RemoteObject*/ )));
...
Debug.ShouldStop(134217728);
__ref.setField ("_sql1" /*RemoteObject*/ ,addsalesinfo._main._pool /*RemoteObject*/ .runMethod(false,"GetConnection"));
 BA.debugLineNum = 30;BA.debugLine="Load_Customer";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_customer" /*RemoteObject*/ );
 BA.debugLineNum = 32;BA.debugLine="Load_Products";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_products" /*RemoteObject*/ );
 BA.debugLineNum = 34;BA.debugLine="Load_PaymentTypes";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_paymenttypes" /*RemoteObject*/ );
 BA.debugLineNum = 36;BA.debugLine="Load_UsersInformation";
Debug.ShouldStop(8);
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_usersinformation" /*RemoteObject*/ );
 BA.debugLineNum = 37;BA.debugLine="Load_Data_ByID";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.addsalesinfo.class, "_load_data_byid" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (addsalesinfo) ","addsalesinfo",16,__ref.getField(false, "ba"),__ref,42);
if (RapidSub.canDelegate("websocket_disconnected")) { return __ref.runUserSub(false, "addsalesinfo","websocket_disconnected", __ref);}
